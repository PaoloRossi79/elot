...
?>
	...
	<div class="row">
		<?php echo $form->textFieldRow($model, 'first_name', array('class' => 'span3','size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->textFieldRow($model, 'last_name', array('class' => 'span3','size'=>45,'maxlength'=>45)); ?>
	</div>
...
<div class="form span5">
    <?php $this->renderPartial('application.views.users._buyCredit', array('model'=>$model->user)); ?>
</div>