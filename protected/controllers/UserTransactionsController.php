...
class UserTransactionsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['UserTransactions'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('UserTransactions');
	...
	{
		$model=UserTransactions::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UserTransactions $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-transactions-form')
		{
