...
<div class="lot-panel panel panel-default bootstrap-widget-table">
    ...
    <div class="panel-body">
        <?php if(!empty($model->id)){ ?>
            <?php $this->lotController->renderPartial('_galleryImage',array('model'=>$model)); ?>
        <?php } ?>
        <div class="col-md-12">
        ...
        <?php if($model->owner->id == $this->lotController->userId){ ?>
            <div class="col-md-4">
        ...
        <div class="col-md-12">
            <?php if(isset($this->lotController->userId) && $this->lotController->userId!=$model->owner_id){ ?>
...
<?php if(isset($this->lotController->userId) && $this->lotController->userId!=$model->owner_id){ ?>
    <?php $this->lotController->renderPartial('_buyModal',array('data'=>$model, 'addData' => $addData)); ?>
    <?php $this->lotController->renderPartial('_giftModal',array('data'=>$model)); ?>
<?php } ?>