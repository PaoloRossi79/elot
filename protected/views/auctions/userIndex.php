            ...
            array(            // display a column with "view", "update" and "delete" buttons
                ...
                (
                    ...
                    (
                        ...
                        'imageUrl'=>false,
                        'url'=>'Yii::app()->createUrl("auctions/view", array("id"=>$data->id))',
                    ),
                    'update' => array
                    (
                        'label'=>'<span class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-edit">Modifica</i></span>',
                        'imageUrl'=>false,
                        'url'=>'Yii::app()->createUrl("auctions/update", array("id"=>$data->id))',
                    ...
                    (
                        ...
                        'imageUrl'=>false,
                        'url'=>'Yii::app()->createUrl("auctions/clone", array("id"=>$data->id))',
                    ),
                    'void' => array
                    (
                        'label'=>'<span class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove">Annulla</i></span>',
                        'imageUrl'=>false,
                        'url'=>'Yii::app()->createUrl("auctions/void", array("id"=>$data->id))',
                    ...
                    (
                        ...
                        'imageUrl'=>false,
                        'url'=>'Yii::app()->createUrl("auctions/delete", array("id"=>$data->id))',
