...
<p>
    ...
    <a href="<?php echo Yii::app()->createUrl(Yii::app()->baseUrl . '/site/oauth', array('provider' => $provider)); ?>" class="zocial <?php echo $additionalClass . ' ' . strtolower($provider); ?>"><?php echo "$invitation $provider"; ?></a>
</p>